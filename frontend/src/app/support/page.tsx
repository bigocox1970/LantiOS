...
export default function SupportPage() {
    ...
    const feedbackTypes: {
        ...
        },
        {
            value: "question",
            label: "Question",
            description: "Ask a question about using Lanti OS",
        },
        {
            value: "other",
            label: "Other",
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {feedbackType === "bug" && (
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 border border-border rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all"
                                    />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={5}
                                    className="w-full px-4 py-2.5 border border-border rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all resize-none"
                                    required
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center gap-2"
                            >
                                {isSubmitting ? (
                                    <>

        ...
        <>
            {onNewSubfolder && (
                <button
                    ...
                    className="flex items-center gap-2 w-full px-3 py-2 text-xs text-left text-muted-foreground hover:bg-muted/50 transition-colors"
                >
    ...
    return (
        <>
            <button
                ...
                className="flex items-center justify-center w-6 h-6 rounded text-foreground/80 hover:text-foreground hover:bg-accent transition-colors leading-none"
            >
            ...
            {open && (
                <div
                    ...
                    className="z-[120] w-48 rounded-xl border border-border/60 bg-card shadow-lg overflow-hidden"

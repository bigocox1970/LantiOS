...
function CitationHeader({
    ...
    return (
        <div className="pt-2 pb-3">
            ...
            <div className="w-full rounded-md bg-muted/50 border border-border px-2 py-2">
        ...
        async (verb: "accept" | "reject") => {
            ...
            try {
                ...
                const resp = await fetch(
                    `/api/single-documents/${edit.document_id}/edits/${edit.edit_id}/${verb}`,
                    {
                        method: "POST",
                        headers: token
    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                className="inline-flex items-center gap-1 rounded-lg border border-foreground bg-foreground px-2 py-1.5 text-xs font-medium text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
                ...
                disabled={inFlight || resolved}
                className="inline-flex items-center gap-1 rounded-lg border border-border bg-card px-2 py-1.5 text-xs font-medium text-foreground/80 hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed"
            >
...
function DownloadButton({
    ...
    const handleClick = async () => {
        ...
        try {
            ...
            const qs = versionId
                ...
                : "";
            const resp = await fetch(
                `/api/single-documents/${documentId}/docx${qs}`,
                {
    ...
    return (
        <button
            onClick={handleClick}
            disabled={spinning}
            className="inline-flex items-center gap-1 rounded-lg border border-border px-2 py-1.5 text-xs font-medium text-muted-foreground hover:bg-accent hover:text-foreground/90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
            {spinning ? (

        ...
        <div className="rounded-sm border border-border/60 overflow-hidden">
            <div>
                ...
                {standaloneDocs.length > 0 && directoryProjects.length > 0 && (
                    <div className="border-t border-border/60 py-2 px-2">
                        <p className="text-xs font-medium text-muted-foreground/70">
                            Projects
                        </p>
                    </div>
                    ...
                    return (
                        <div key={project.id}>
                            <button
                                ...
                                className="w-full flex items-center gap-2 px-2 py-2 text-xs hover:bg-muted/50 transition-colors text-left"
                            >
                                {isExpanded ? (

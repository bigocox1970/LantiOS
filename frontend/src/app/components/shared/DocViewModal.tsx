        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between px-5 py-3 shrink-0">
                    <span className="text-base font-medium font-serif text-foreground/90 truncate pr-4">
                        {doc.filename}
                        {versionLabel && (
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        <button
                            ...
                            className="flex items-center justify-center w-6 h-6 rounded hover:bg-accent text-muted-foreground/70 hover:text-foreground/80 transition-colors"
                        >

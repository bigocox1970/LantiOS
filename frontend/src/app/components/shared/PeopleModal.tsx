                    ...
                    <div className="px-4 pt-1 pb-2">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                disabled={!canAdd}
                                title="Add member"
                                className="inline-flex items-center justify-center rounded-lg border border-foreground bg-foreground p-2 text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {busy === "add" ? (

    ...
    return (
        ...
        >
            <div
                ...
                className="flex-1 overflow-auto bg-accent px-3 pt-5 pb-3"
            >
                {loading && (
            ...
            {numPages > 0 && (
                <>
                    ...
                    <div className="absolute bottom-4 left-4 pointer-events-none">
                        <span className="flex items-center px-3 py-1.5 rounded-full text-xs font-medium tabular-nums text-foreground/80 bg-white/25 backdrop-blur-md border border-white/30 shadow-md">
                    ...
                    <div className="absolute bottom-4 right-4 flex items-center gap-px rounded-full bg-white/25 backdrop-blur-md border border-white/30 shadow-md px-1 py-1">
                        <button
                            ...
                            className="flex items-center justify-center w-7 h-7 rounded-full text-muted-foreground hover:bg-white/80 disabled:opacity-30 transition-colors"
                        >

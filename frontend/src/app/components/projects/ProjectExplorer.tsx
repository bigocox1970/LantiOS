                ...
                {creatingIn === parentId && (
                    ...
                    >
                        ...
                        <input
                            ...
                            autoFocus
                            className="flex-1 min-w-0 text-xs bg-transparent outline-none border-b border-border text-foreground/90"
    ...
    return (
        ...
        >
            ...
            {contextMenu && (
                <div
                    ref={contextMenuRef}
                    className="fixed z-50 w-44 rounded-lg border border-border/60 bg-card shadow-lg overflow-hidden text-xs"
                    style={{ top: contextMenu.y, left: contextMenu.x }}
                >
                    {onCreateFolder && (
                        <button
                            className="w-full px-3 py-1.5 text-left text-foreground/80 hover:bg-muted/50 flex items-center gap-2"
                            onClick={() => {
                                setContextMenu(null);
                    ...
                    {contextMenu.folderId && onRenameFolder && (
                        <button
                            className="w-full px-3 py-1.5 text-left text-foreground/80 hover:bg-muted/50"
                            onClick={() => {

                ...
                >
                    <div className="px-6 pt-3 pb-4 space-y-5 overflow-y-auto flex-1">
                        ...
                        <input
                            ...
                            className="w-full text-2xl font-serif text-foreground/90 placeholder-gray-400 focus:outline-none bg-transparent"
                            autoFocus
                        />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center justify-between w-full rounded-lg border border-border px-3 py-2 text-sm hover:border-gray-400 focus:outline-none bg-card transition-colors"
                                >
                                ...
                                {workflowDropdownOpen && !loadingWorkflows && (
                                    <div className="absolute left-0 top-full z-20 mt-1 w-full rounded-xl border border-border/60 bg-card shadow-lg overflow-y-auto max-h-52">
                                        <button
                                            type="button"
                                            onClick={() => {
                                                setSelectedWorkflowId(null);
                                            ...
                                            className={`w-full text-left flex items-center gap-2 px-3 py-2 text-sm transition-colors hover:bg-muted/50 ${!selectedWorkflowId ? "bg-muted/50 text-foreground" : "text-muted-foreground"}`}
                                        >
                                        ...
                                        {workflows.map((wf) => (
                                            <button
                                                ...
                                                className={`w-full text-left flex items-center gap-2 px-3 py-2 text-sm transition-colors hover:bg-muted/50 ${selectedWorkflowId === wf.id ? "bg-muted/50 text-foreground" : "text-foreground/80"}`}
                                            >
                        ...
                        {!isProjectMode && <div className="space-y-3">
                            ...
                            >
                                <span
                                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors duration-200 ${underProject ? "bg-foreground" : "bg-border"}`}
                                >
                                    <span
                            ...
                            {underProject && (
                                <div className="relative">
                                    ...
                                    {projectDropdownOpen && (
                                        <div className="absolute left-0 top-full z-20 mt-1 w-full rounded-xl border border-border/60 bg-card shadow-lg overflow-y-auto max-h-48">
                                            {projects.length === 0 ? (
                                                ...
                                                projects.map((p) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left flex items-center justify-between px-3 py-2 text-sm transition-colors hover:bg-muted/50 ${selectedProjectId === p.id ? "bg-muted/50 text-foreground" : "text-foreground/80"}`}
                                                    >
                    ...
                    {/* Footer */}
                    <div className="flex items-center justify-between gap-2 border-t border-border/60 px-6 py-4 shrink-0">
                        <div>
                            <input
                                ref={fileInputRef}
                                type="file"
                            ...
                            <button
                                ...
                                disabled={uploading}
                                className="flex items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-sm text-muted-foreground hover:bg-muted/50 disabled:opacity-50 transition-colors"
                            >
                                {uploading ? (

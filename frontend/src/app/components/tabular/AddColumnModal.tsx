                            ...
                            >
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    >
                                        <input
                                            ...
                                            className="flex-1 text-2xl font-serif text-foreground/90 placeholder-gray-400 focus:outline-none bg-transparent"
                                            autoFocus={index === 0}
                                        />
                                        <button
                                            type="button"
                                            ...
                                            className="mt-1.5 rounded-lg p-1.5 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground/80"
                                        >
                                            <ChevronDown
                                        ...
                                        {presetsOpenIndex === index && (
                                            <div className="absolute left-0 right-0 top-full mt-1 z-50 rounded-xl border border-border/60 bg-card shadow-lg overflow-y-auto max-h-64">
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                    ...
                                                    className="w-full px-3 py-2 text-left text-sm text-muted-foreground/70 hover:bg-muted/50 transition-colors border-b border-border/60"
                                                >
                                                    No Preset
                                                </button>
                                                {PROMPT_PRESETS.map(
                                                    (preset) => (
                                                        <button
                                                            ...
                                                            className="w-full px-3 py-2 text-left text-sm text-foreground/80 hover:bg-muted/50 transition-colors"
                                                        >
                                                            {preset.name}
                                                        </button>
                                                    ),
                                    ...
                                    {columns.length > 1 && (
                                        <button
                                            ...
                                            className="mt-1.5 rounded-lg p-1.5 text-muted-foreground/50 transition-colors hover:bg-accent hover:text-muted-foreground"
                                        >
                                            <X className="h-4 w-4" />
                                        </button>
                                    )}
                                ...
                                <div className="mt-4">
                                    ...
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <button className="mt-1 flex items-center justify-between rounded-md border border-border bg-card px-2 py-1.5 text-sm text-foreground/80 hover:border-gray-400 focus:outline-none">
                                ...
                                {column.format === "tag" && (
                                    <div className="mt-3">
                                        ...
                                        <div className="mt-1 flex flex-wrap gap-1.5 rounded-md border border-border px-2 py-1.5 focus-within:border-gray-400">
                                ...
                                <textarea
                                    ...
                                    className="mt-2 w-full rounded-md border border-border px-3 py-2 text-sm text-foreground/80 placeholder-gray-400 focus:border-gray-400 focus:outline-none bg-transparent resize-none leading-relaxed"
                                />
                            </div>
                        ))}

...
export function TREditColumnMenu({
    ...
    return (
        <div className="relative shrink-0" onClick={(e) => e.stopPropagation()}>
            ...
            {open && (
                <div
                    className="absolute right-0 top-full z-20 mt-1.5 w-72 rounded-xl border border-border/60 bg-card p-3 shadow-lg"
                ...
                >
                    ...
                    <input
                        ...
                        className="mt-1 w-full rounded-md border border-border px-2 py-1 text-foreground/90 text-xs font-normal focus:border-gray-400 focus:outline-none"
                    />
                    ...
                    <div className="mt-3">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="mt-1 flex w-full items-center justify-between rounded-md border border-border bg-card px-2 py-1 text-xs text-foreground/80 hover:border-gray-400 focus:outline-none">
                    ...
                    {format === "tag" && (
                        <div className="mt-2">
                            <div className="flex flex-wrap gap-1 rounded-md border border-border px-2 py-1 focus-within:border-gray-400 min-h-[28px]">
                                {tags.map((tag, tagIdx) => (
                                    <span
                                        key={tag}
                    ...
                    <div className="mt-3">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground/80 disabled:text-muted-foreground/50"
                            >
                                {generating ? (
                        ...
                        <textarea
                            ...
                            className="mt-2 w-full rounded-lg border border-border bg-card px-3 py-2 text-xs font-normal text-foreground/90 placeholder-gray-300 focus:border-gray-400 focus:outline-none resize-none leading-relaxed"
                        />
                    </div>

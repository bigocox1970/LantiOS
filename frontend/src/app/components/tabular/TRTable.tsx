        ...
        return (
            <div className="flex-1 overflow-hidden">
                ...
                {Array.from({ length: SKELETON_ROWS }).map((_, row) => (
                    <div
                        key={row}
                        className={`flex border-b border-border/40 ${row % 2 === 0 ? "bg-card" : "bg-muted/50"}`}
                    >
                ...
                <div className="relative flex min-h-0 flex-1">
                    ...
                    <div className="flex flex-1 flex-col items-start justify-center w-full max-w-xs mx-auto">
                        ...
                        <div className="mt-4 flex items-center gap-2">
                            <button
                                onClick={onAddColumn}
                                className="inline-flex items-center gap-1 rounded-full bg-primary px-3 py-1 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary/90 shadow-md"
                            >
                                + Add Columns
                            </button>
                            <button
                                onClick={onAddDocuments}
                                className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground hover:bg-muted/50 transition-colors shadow-sm"
                            >
        ...
        >
            ...
            >
                ...
                <div className="flex-1 border-b border-border flex items-center justify-start p-2 min-w-8">
                    <button
                        onClick={onAddColumn}
                        disabled={savingColumn || savingColumnsConfig}
                        className="flex items-center justify-center text-muted-foreground/70 hover:text-foreground/80 transition-colors disabled:text-gray-200"
                    >
            ...
            <div className="relative min-h-0 flex-1">
                    ...
                    >
                        ...
                        >
                            <input
                                type="checkbox"
                                disabled
                                className="h-2.5 w-2.5 shrink-0 rounded border-border cursor-default accent-black disabled:opacity-100"
                            />
                        </div>
                        <div
                            className={`sticky left-8 z-[60] ${COL_W} border-b border-r border-border p-2 text-xs text-muted-foreground/70 flex items-center gap-2 bg-card`}
                        >
                ...
                {documents.map((doc, docIdx) => {
                    const baseRowBg =
                        docIdx % 2 === 0 ? "bg-card" : "bg-muted/50";
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                className={`sticky left-8 z-[60] ${COL_W} border-b border-r border-border p-2 text-xs text-foreground/90 flex items-center ${baseRowBg}`}
                            >
                                <span

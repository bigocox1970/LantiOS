    ...
    return (
        <DropdownMenu onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
                <button
                    type="button"
                    className={`flex items-center gap-1.5 rounded-lg px-2 h-8 text-sm transition-colors cursor-pointer text-muted-foreground/70 hover:bg-accent hover:text-foreground/80 ${isOpen ? "bg-accent text-foreground/80" : ""}`}
                    title={
                        !selectedAvailable

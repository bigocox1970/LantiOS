        ...
        <div className="border border-border rounded-lg p-3 bg-muted/50">
            ...
            <div className="flex gap-2 mt-3">
                <button
                    ...
                    className="px-2 py-1 text-xs rounded border border-foreground bg-foreground text-white hover:bg-gray-800 disabled:opacity-50"
                >
                ...
                <button
                    ...
                    disabled={inFlight || resolved}
                    className="px-2 py-1 text-xs rounded border border-border bg-card text-foreground/80 hover:bg-accent disabled:opacity-50"
                >
                ...
                {onViewClick && (
                    <button
                        ...
                        className="ml-auto px-2 py-1 text-xs rounded border border-border bg-card text-foreground/80 hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-card"
                    >
                        View
                    </button>
                )}

                    ...
                    <div className="flex items-center justify-between md:p-2.5 p-2">
                        <div className="flex items-center gap-1">
                            ...
                            {!hideWorkflowButton && (
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 rounded-lg px-2 h-8 text-sm transition-colors ${selectedWorkflow ? "text-blue-600 hover:bg-blue-50" : "text-muted-foreground/70 hover:bg-accent hover:text-foreground/80"}`}
                                >
                                    {selectedWorkflow ? (
                            ...
                            {onProjectsClick && (
                                <button
                                    ...
                                    className="flex items-center gap-1.5 rounded-lg px-2 h-8 text-sm text-muted-foreground/70 hover:bg-accent hover:text-foreground/80 transition-colors"
                                >
                        ...
                        <div className="flex items-center gap-1">
                            <button
                                ...
                                className={`flex items-center gap-1.5 rounded-lg px-2 h-8 text-sm transition-colors ${isListening ? "text-red-500 hover:bg-red-50" : "text-muted-foreground/70 hover:bg-accent hover:text-foreground/80"}`}

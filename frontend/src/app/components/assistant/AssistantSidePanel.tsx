...
export function AssistantSidePanel({
    ...
    return (
        ...
        >
            ...
            <div className="flex items-end gap-1 pr-2 pt-2 bg-accent">
                        ...
                        return (
                            <div
                                ...
                                className={`group relative flex items-center gap-1.5 pl-3 pr-1.5 h-8 min-w-0 max-w-[220px] rounded-t-lg cursor-pointer select-none transition-colors ${
                                    isActive
                                        ? "bg-card text-foreground/90 before:content-[''] before:absolute before:bottom-0 before:-left-2 before:w-2 before:h-2 before:bg-[radial-gradient(circle_at_top_left,transparent_8px,white_9px)] after:content-[''] after:absolute after:bottom-0 after:-right-2 after:w-2 after:h-2 after:bg-[radial-gradient(circle_at_top_right,transparent_8px,white_9px)]"
                                        : "bg-muted/70 text-muted-foreground hover:bg-border"
                                }`}
                            >
                                <span
                ...
                <button
                    onClick={onCloseAll}
                    className="shrink-0 mb-1 ml-1 rounded-lg p-1.5 text-muted-foreground/70 hover:bg-border hover:text-foreground/80"
                    title="Close panel"
                >
                    <X className="h-4 w-4" />
                </button>

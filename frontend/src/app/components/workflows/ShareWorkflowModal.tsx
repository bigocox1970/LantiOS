    ...
    return createPortal(
        <div className="fixed inset-0 z-[101] flex items-center justify-center bg-black/20 backdrop-blur-xs">
            <div className="w-full max-w-2xl rounded-2xl bg-card shadow-2xl flex flex-col h-[600px]">
                ...
                <div className="px-5 py-4 flex flex-col gap-4 flex-1 overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ${allowEdit ? "bg-foreground" : "bg-border"}`}
                        >
                ...
                {/* Footer */}
                <div className="border-t border-border/60 px-5 py-3 flex justify-end gap-2 mt-auto shrink-0">
                    <button
                        onClick={onClose}

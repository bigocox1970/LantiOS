                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="px-6 pt-3 pb-5 flex-1 overflow-y-auto">
                        ...
                        <input
                            ...
                            className="w-full text-2xl font-serif text-foreground/90 placeholder-gray-300 focus:outline-none bg-transparent"
                            autoFocus
                        />
                        ...
                        <div className="mt-5">
                            ...
                            {isOthers && (
                                <input
                                    ...
                                    className="mt-3 w-full rounded-md border border-border px-3 py-1.5 text-sm text-foreground/80 placeholder-gray-400 focus:border-gray-400 focus:outline-none"
                                />
                            )}
                        </div>
                    ...
                    {/* Footer */}
                    <div className="flex items-center justify-end gap-2 border-t border-border/60 px-6 py-4 shrink-0">
                        <button
                            type="button"
                            onClick={handleClose}

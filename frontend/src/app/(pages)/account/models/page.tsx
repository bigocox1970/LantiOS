    ...
    return (
        <div className="space-y-4">
            ...
            <div className="py-6">
                ...
                <p className="text-xs text-muted-foreground/70 mb-4 max-w-xl">
    ...
    return (
        <DropdownMenu onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
                <button
                    type="button"
                    className="w-full h-9 rounded-md border border-border bg-card px-3 text-sm shadow-sm flex items-center justify-between gap-2 hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-black/10"
                >
            ...
            <div className="flex gap-2">
                <div className="relative flex-1">
                    ...
                    <button
                        ...
                        disabled={isServerConfigured}
                        className="absolute inset-y-0 right-2 flex items-center text-muted-foreground/70 hover:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-40"

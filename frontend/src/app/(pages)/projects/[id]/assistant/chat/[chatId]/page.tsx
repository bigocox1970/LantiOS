            ...
            <div className="flex items-center justify-between px-8 py-4 shrink-0">
                <div className="flex items-center gap-1.5 text-2xl font-medium font-serif">
                    ...
                    {project ? (
                        ...
                        <div className="h-6 w-32 rounded bg-accent animate-pulse" />
                    )}
                    <span className="text-muted-foreground/50">›</span>
                    <button
                        onClick={() =>
                            ...
                            <div className="h-10 flex items-center justify-between px-3 border-b border-border shrink-0">
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <button
                                        ...
                                        className="p-1 rounded text-muted-foreground/70 hover:text-foreground/80 hover:bg-accent transition-colors disabled:opacity-40"
                                    >
                                        {uploading ? (
                                    ...
                                    <button
                                        ...
                                        className="p-1 rounded text-muted-foreground/70 hover:text-foreground/80 hover:bg-accent transition-colors"
                                    >
                ...
                <div className="flex-1 flex flex-col min-w-0 border-r border-border">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`shrink-0 transition-colors ${isActive ? "text-muted-foreground hover:text-foreground/80" : "text-muted-foreground/50 hover:text-muted-foreground"}`}
                                        >
                                            <X className="h-3 w-3" />
                                        </button>
                                    </div>
                    ...
                    <div className="flex-1 min-h-0 overflow-hidden flex flex-col">
                        {activeTab ? (
                            ...
                            <div className="flex items-center justify-center h-full px-8 bg-accent">
                    ...
                    {!chatLoaded ? (
                        <div className="flex-1 px-4 py-4 space-y-4">
                            <div className="flex justify-end">
                                <div className="bg-accent rounded-2xl p-4 w-3/4">

            ...
            <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-between px-8 py-4 shrink-0">
                    <div className="flex items-center gap-1.5">
                        <div className="h-6 w-24 rounded bg-accent animate-pulse" />
                ...
                <div className="flex items-center h-8 pr-8 border-b border-border shrink-0">
                    <div className="w-8 shrink-0 border-r border-border/60 self-stretch" />
                    <div className="flex-1 pl-3">
                        <div className="h-2.5 w-20 rounded bg-accent animate-pulse" />
                    </div>
                    <div className="w-36 shrink-0">
                        <div className="h-2.5 w-14 rounded bg-accent animate-pulse" />
                    </div>
                    <div className="flex-1">
                        <div className="h-2.5 w-12 rounded bg-accent animate-pulse" />
                    </div>
                ...
                <div className="flex-1 overflow-hidden">
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div key={i} className="flex items-center h-10 pr-8 border-b border-border/40">
                            <div className="w-8 shrink-0 border-r border-border/60 self-stretch" />
                            <div className="flex-1 pl-3 pr-4">
                                <div className="h-3 rounded bg-accent animate-pulse" style={{ width: `${40 + (i * 13) % 35}%` }} />
                            </div>
                            <div className="w-36 shrink-0">
                                <div className="h-3 w-16 rounded bg-accent animate-pulse" />
                            </div>
                            <div className="flex-1 pr-4">
                                <div className="h-3 rounded bg-accent animate-pulse" style={{ width: `${50 + (i * 17) % 35}%` }} />
                            </div>
                            <div className="w-8 shrink-0" />
                        </div>
                    ))}
                            ...
                            {columns.length === 0 ? (
                                ...
                                columns.map((col) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                className={`sticky left-0 z-[60] ${CHECK_W} p-2 flex items-center justify-center ${isChecked ? "bg-muted/50" : "bg-card"} group-hover:bg-muted/50`}
                                            ...
                                            <div className={`sticky left-8 z-[60] ${NAME_COL_W} p-2 ${isChecked ? "bg-muted/50" : "bg-card"} group-hover:bg-muted/50`}>

                        ...
                        <div className="flex-1 flex flex-col h-dvh md:overflow-hidden relative w-full">
                            ...
                            <div className="flex md:hidden items-center gap-3 px-4 pt-3 pb-1 shrink-0">
                                <button
                                    ...
                                    className="flex h-8 w-8 items-center justify-center rounded-full bg-card/70 text-foreground/80 shadow-[0_8px_24px_rgba(15,23,42,0.12)] ring-1 ring-border/70 backdrop-blur-md transition-all hover:bg-card/90 active:scale-95"
                                    title="Open sidebar"

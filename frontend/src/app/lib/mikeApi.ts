...
// All API routes are served from the same Next.js origin under /api
const API_BASE = "";
...
export async function uploadDocumentVersion(
    ...
    const response = await fetch(
        `/api/single-documents/${documentId}/versions`,
        {
            method: "POST",
            headers: { ...authHeaders },
            body: form,
...
export async function uploadStandaloneDocument(
    ...
    const form = new FormData();
    form.append("file", file);
    const response = await fetch(`/api/single-documents`, {
        method: "POST",
        headers: { ...authHeaders },
        body: form,
    });
...
export async function downloadDocumentsZip(
    ...
    const authHeaders = await getAuthHeader();
    const response = await fetch(`/api/single-documents/download-zip`, {
        method: "POST",
        cache: "no-store",
        headers: {
...
export async function streamTabularGeneration(
    ...
    const authHeaders = await getAuthHeader();
    return fetch(`/api/tabular-review/${reviewId}/generate`, {
        method: "POST",
        headers: { ...authHeaders },
    });
}
...
export async function streamTabularChat(
    ...
    const authHeaders = await getAuthHeader();
    return fetch(`/api/tabular-review/${reviewId}/chat`, {
        method: "POST",
